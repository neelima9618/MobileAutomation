...
driver.findElement(By.id("inputFirstName")).sendKeys("neelima");
driver.findElement(By.xpath("(//*[@id='inputFirstName'])[2]")).sendKeys("etlam");
driver.findElement(By.id("inputEmail")).sendKeys("Ne@gmail.com");
driver.findElement(By.id("inputPassword")).sendKeys("nee@123");
