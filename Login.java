...
Last_name.sendKeys("etlam");
WebElement Email = driver.findElement(By.xpath("//input[@type='Email']"));
Email.sendKeys("Ne1999@gmail.com");
WebElement password = driver.findElement(By.xpath("//input[@type='Password']"));
password.sendKeys("Ne@123");
WebElement Phone_number = driver.findElement(By.xpath("//input[@type='number']"));
Phone_number.sendKeys("9392452456");
driver.findElement(By.xpath("//input[@type='radio']")).click();
WebElement bio_story = driver.findElement(By.xpath("//textarea[@placeholder='Short Bio']"));
bio_story.sendKeys("neelima is the employee whose join the qulitest company in the last 2 month back");
...
user_name.click();
user_name.sendKeys("Ne1999@gmail.com");
